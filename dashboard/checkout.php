        ...
        <div class="col-md-8 order-md-1">
          ...
          <form class="needs-validation" method="POST">
            ...
            <div class="mb-3">
              ...
              <input type="email" class="form-control" id="email exampleInputEmail1" name="email" value="<?php echo $row['email'];?> <?php echo (isset($emailValue) && !empty($emailValue)) ? $emailValue:'' ?>">
            </div>
            ...
            <hr class="mb-4">
            <button class="btn btn-primary btn-lg btn-block" type="submit" name="submit" value="submit" style="background-color: #9031B1; border: none;">Continue to checkout</button>
            <?php } ?>
          </form>
        </div>
      </div>
